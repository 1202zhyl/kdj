...
import com.bl.bd.util.{Configuration, FileUtil, SparkFactory}
...
object UpLoadExcelToHDFSLH {
  ...
  def main(args: Array[String]) {
    ...
    sc.sequenceFile[Text, Text]("/tmp/kdj/lh")
  ...
  def parseArgs(args: Array[String]): (String, String) = {
    ...
    require(output != null, "please input output file path")
    (input, output)
  }
